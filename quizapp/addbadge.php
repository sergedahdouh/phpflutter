		...
		<div class="tab-content" id="myTabContent">	
			<div role="tabpanel">
				<div class="card">
					...
					<div class="card-body">
						<form class="form" role="form" method="post" action="action/add_badge.php" enctype="multipart/form-data" autocomplete="off">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Badge Key</label>
								<div class="col-lg-9">
									<input class="form-control" name="badgekey">
								</div>
							</div>	
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Badge Required</label>
								<div class="col-lg-9">
									<input class="form-control" name="badreq">
								</div>
							</div>										
							<div class="form-group row">
