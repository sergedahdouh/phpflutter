						...
						<?php
							...
							if (isset($_POST['submit'])) {
								...
								if($_FILES['photo']['name']!=""){
									...
									$query = "UPDATE tbl_category SET cat_name = '".$name."', photo_cat = '".$md5photo."', cat_status = '".$valueStatus."' WHERE cat_id = '".$id."'";
								...
								$query = "UPDATE tbl_category SET cat_name = '".$name."', cat_status = '".$valueStatus."' WHERE cat_id = '".$id."'";
								mysqli_query($conn, $query);
